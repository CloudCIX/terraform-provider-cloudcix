...
page_title: "cloudcix_storage_volume Data Source - cloudcix"
subcategory: ""
description: |-
  ...
  - Ceph volumes use Ceph storage SKUs (CEPH001 for HDD, CEPH002 for SSD)
  - Hyper-V volumes use storage SKUs (e.g., SSD001, HDD001)
  Available SKUs depend on your region's configured devices.
---

# cloudcix_storage_volume (Data Source)
...
```terraform
data "cloudcix_storage_volume" "example_storage_volume" {
  id = 0
}
```
