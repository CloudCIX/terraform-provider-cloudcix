...
func DataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		MarkdownDescription: "Management of Network VPNs\nSupported Types are:\n- site-to-site",
		Attributes: map[string]schema.Attribute{
			...
			"metadata": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[NetworkVpnMetadataDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"child_sas": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[NetworkVpnMetadataChildSasDataSourceModel](ctx),
			...
			"specs": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[NetworkVpnSpecsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
