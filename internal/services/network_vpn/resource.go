...
// NetworkVpnResource defines the resource implementation.
...
func (r *NetworkVpnResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.Network.Vpns.New(
		ctx,
		gocloudcix.NetworkVpnNewParams{},
...
func (r *NetworkVpnResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Network.Vpns.Delete(
		ctx,
		data.ID.ValueInt64(),
		option.WithMiddleware(logging.Middleware(ctx)),
	)
...
func (r *NetworkVpnResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
