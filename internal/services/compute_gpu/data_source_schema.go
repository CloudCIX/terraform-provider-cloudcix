	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"content": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ComputeGPUContentDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"id": schema.Int64Attribute{
					...
					"instance": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[ComputeGPUContentInstanceDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"id": schema.Int64Attribute{
					...
					"specs": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[ComputeGPUContentSpecsDataSourceModel](ctx),
