...
var _ datasource.DataSourceWithConfigure = (*NetworkRouterDataSource)(nil)
...
func (d *NetworkRouterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *NetworkRouterDataSourceModel
	...
	env := NetworkRouterContentDataSourceEnvelope{*data}
	_, err := d.client.Network.Routers.Get(
		ctx,
		data.ID.ValueInt64(),
