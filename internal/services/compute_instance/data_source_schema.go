	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"interfaces": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[ComputeInstanceInterfacesDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"ipv4_addresses": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[ComputeInstanceInterfacesIpv4AddressesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.Int64Attribute{
						...
						"ipv6_addresses": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[ComputeInstanceInterfacesIpv6AddressesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.Int64Attribute{
										Description: "The ID of the IP Address record on the Interface.",
			...
			"metadata": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[ComputeInstanceMetadataDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"specs": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ComputeInstanceSpecsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
