...
var _ datasource.DataSourceWithConfigure = (*ComputeInstanceDataSource)(nil)
...
func (d *ComputeInstanceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := ComputeInstanceContentDataSourceEnvelope{*data}
	_, err := d.client.Compute.Instances.Get(
		ctx,
		data.ID.ValueInt64(),
