	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"content": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[StorageVolumeContentDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"id": schema.Int64Attribute{
					...
					"contra_instances": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[StorageVolumeContentContraInstancesDataSourceModel](ctx),
					...
					"instance": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[StorageVolumeContentInstanceDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"id": schema.Int64Attribute{
					...
					"metadata": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[StorageVolumeContentMetadataDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"specs": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[StorageVolumeContentSpecsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
